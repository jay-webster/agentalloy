...
- Container image (``ghcr.io/jay-webster/agentalloy:latest``) for container
  deployments.
...
def _remove_container_image(
    ...
    if binary is None:
        warnings.append(
            ...
            "`<podman|docker> rmi -f ghcr.io/jay-webster/agentalloy:latest`"
        )
        return actions
...
def uninstall(
    ...
    *,
    ...
    allowed_path_suffixes = (
        ...
        ".qwen/settings.json",  # qwen-code repo-local proxy carrier (QWEN_HOME)
